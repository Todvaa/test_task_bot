...
Для обработки пользовательских файлов структура колонок должна быть идентичной prices.csv. Пользовательский файл должен быть помещен в директорию
проекта. См. Примеры использования.
